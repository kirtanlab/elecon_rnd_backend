...
@Getter
@Setter
public class EmailFieldGenerator {
  private String name;
  ...
  public EmailFieldGenerator(String name, String label, boolean required, String defaultValue, boolean show) {
    this.name = name;
    this.label = label;
  ...
  public EmailFieldGenerator(String name, String label, boolean required, String defaultValue, boolean show,boolean disabled) {
    this.name = name;
    this.label = label;
    this.required = required;
    this.defaultValue = defaultValue;
